<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Permanently delete this company and all of its data.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-confirmation-modal wire:model="confirmingTeamDeletion">
            ...
            <x-slot name="content">
                {{ __('Are you sure you want to delete this team? Once a company is deleted, all of its resources and data will be permanently deleted.') }}
            </x-slot>
